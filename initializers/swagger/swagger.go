...
func New(swaggerUIOpts middleware.SwaggerUIOpts, config ...Config) fiber.Handler {
	// Set default config
	cfg := ConfigDefault
	...
	// Update UI Options
	swaggerUIOpts.BasePath = cfg.BasePath
	swaggerUIOpts.SpecURL = specURL
	swaggerUIOpts.Path = cfg.Path
	swaggerUIOpts.Title = cfg.Title
